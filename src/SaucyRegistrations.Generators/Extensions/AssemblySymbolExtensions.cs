...
//     internal static List<string> GetIncludedNamespaces(this IAssemblySymbol assembly)
//     {
...
internal static class AssemblySymbolExtensions
{
    internal static List<string> GetIncludedNamespaces(this IAssemblySymbol assembly)
    {
        ...
        List<AttributeData> attributes = assembly.GetAttributesOfType<SaucyAddNamespace>();
        ...
        foreach (AttributeData attribute in attributes)
        {
            var includedNamespace = attribute.GetValueForPropertyOfType<string>(nameof(SaucyAddNamespace.Namespace));
            result.Add(includedNamespace);
        }
