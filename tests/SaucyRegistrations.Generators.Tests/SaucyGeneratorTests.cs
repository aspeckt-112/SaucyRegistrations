...
public class SaucyGeneratorTests : BaseTest
{
    ...
    [Fact]
    public async Task SaucyInclude_When_ServiceIsHostedService_Should_RegisterHostedService()
    {
        const string input = """
                             namespace SaucyRegistrations.TestProject;

                             [SaucyInclude(ServiceScope.Singleton)]
                             public class TestHostedService : Microsoft.Extensions.Hosting.IHostedService
                             {
                                    public System.Threading.Tasks.Task StartAsync(System.Threading.CancellationToken cancellationToken) => throw new System.NotImplementedException();
                                    public System.Threading.Tasks.Task StopAsync(System.Threading.CancellationToken cancellationToken) => throw new System.NotImplementedException();
                             }
                             """;
        ...
        const string expected = """
                                ...
                                public static class TestProjectServiceCollectionExtensions
                                {
                                    public static IServiceCollection AddTestProjectServices(this IServiceCollection services)
                                    {
                                        services.AddHostedService<SaucyRegistrations.TestProject.TestHostedService>();
                                        return services;
                                    }
                                }
                                """;
    ...
    [Fact]
    public async Task SaucyInclude_When_ServiceIsBackgroundService_Should_BeRegisteredAsHostedService()
    {
        const string input = """
                             namespace SaucyRegistrations.TestProject;
                             ...
                             {
                                    protected override System.Threading.Tasks.Task ExecuteAsync(System.Threading.CancellationToken stoppingToken) => throw new System.NotImplementedException();
                             }
                             """;
        ...
        const string expected = """
                                ...
                                public static class TestProjectServiceCollectionExtensions
                                {
                                    public static IServiceCollection AddTestProjectServices(this IServiceCollection services)
                                    {
                                        services.AddHostedService<SaucyRegistrations.TestProject.TestBackgroundService>();
                                        return services;
                                    }
                                }
                                """;
